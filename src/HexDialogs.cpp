...
//				</body></html>
			...
			cb+=wxString::Format( " hexData[0x%x] = {" wxNewline "  ", count );
...
//					}
			...
			wxString HexFormat;
			switch( HexSize ){
				case 1: HexFormat += wxNewline "db "; break;
				case 2: HexFormat += wxNewline "dw "; break;
				case 4: HexFormat += wxNewline "dd "; break;
				case 8: HexFormat += wxNewline "dq "; break;
				}
