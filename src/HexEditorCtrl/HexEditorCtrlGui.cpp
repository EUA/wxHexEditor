...
HexEditorCtrlGui::HexEditorCtrlGui( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
	...
	hex_ctrl->Connect( wxEVT_SET_FOCUS, wxFocusEventHandler( HexEditorCtrlGui::OnFocusChange ), NULL, this );
	text_ctrl->Connect( wxEVT_SET_FOCUS, wxFocusEventHandler( HexEditorCtrlGui::OnFocusChange ), NULL, this );
...
HexEditorCtrlGui::~HexEditorCtrlGui()
{
	...
	hex_ctrl->Disconnect( wxEVT_SET_FOCUS, wxFocusEventHandler( HexEditorCtrlGui::OnFocusChange ), NULL, this );
	text_ctrl->Disconnect( wxEVT_SET_FOCUS, wxFocusEventHandler( HexEditorCtrlGui::OnFocusChange ), NULL, this );
