...
HexEditorGui::HexEditorGui( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	menuFileImportTemplate = new wxMenuItem( fileMenu, idImportTemplate, wxString( _("Import Template") ) , wxEmptyString, wxITEM_NORMAL );
	...
	menuToolsHex2ColorMode = new wxMenuItem( toolsMenu, idHex2Color, wxString( _("Hex2Color Mode") ) , _("Colorize HEX values with representing colors."), wxITEM_CHECK );
...
InterpreterGui::InterpreterGui( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : wxPanel( parent, id, pos, size, style, name )
{
	...
	m_static_ascii = new wxStaticText( this, ID_DEFAULT, _("ASCII"), wxDefaultPosition, wxDefaultSize, wxALIGN_LEFT );
