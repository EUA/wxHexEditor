...
ChecksumDialogGui::ChecksumDialogGui( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	chkTIGER = new wxCheckBox( this, wxID_ANY, wxT("TIGER192"), wxDefaultPosition, wxDefaultSize, 0 );
...
PreferencesDialogGui::PreferencesDialogGui( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	txtCharacter = new wxStaticText( this, wxID_ANY, wxT("Character Encoding:"), wxDefaultPosition, wxDefaultSize, 0 );
	txtCharacter->Wrap( -1 );
	bSizerCharacterEncodings->Add( txtCharacter, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	wxString chcCharacterEncodingChoices[] = { wxT("ANSI - Windows Code page 1252"), wxT("ASCII Code page"), wxT("EBCDIC - IBM Code page 500"), wxT("Macintosh - Code page 10000"), wxT("OEM - IBM PC/DOS Code page 437") };
	...
	chkBytePerLineLimit = new wxCheckBox( this, wxID_ANY, wxT("Bytes Per Line Limit"), wxDefaultPosition, wxDefaultSize, 0 );
