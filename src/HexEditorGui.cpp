...
PreferencesDialogGui::PreferencesDialogGui( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	wxString chcCharacterEncodingChoices[] = { _("ASCII Code page"), _("EBCDIC - IBM Code page 500"), _("GB2312 - Guojia Biaozhun (国家标准)"), _("KOI8-R Код Обмена Информацией, 8 бит"), _("KOI8-U Код Обмена Информацией, 8 бит"), _("Macintosh - Code page 10000"), _("OEM - IBM PC/DOS CP437"), _("OEM - IBM PC/DOS CP850"), _("UTF8 - Universal Character Set"), _("Windows CP1250 - Central and Eastern European"), _("Windows CP1251 - Cyrillic Script"), _("Windows CP1252 - ANSI"), _("Windows CP1253 - Greek Modern"), _("Windows CP1254 - Turkish"), _("Windows CP1257 - Baltic"), _("Windows CP1258 - Vietnamese") };
