...
HexEditorGui::HexEditorGui( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	menuFileQuit = new wxMenuItem( fileMenu, wxID_CLOSE, wxString( _("&Quit") ) + wxT('\t') + _("CTRL+Q"), _("Quit the application"), wxITEM_NORMAL );
...
PreferencesDialogGui::PreferencesDialogGui( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	wxString chcCharacterEncodingChoices[] = { _("ASCII - American Standard Code for Information Interchange"), _("ISCII - Indian Script Code for Information Interchange"), _("GB2312 - Guojia Biaozhun (国家标准)"), _("KOI7 Код Обмена Информацией, 7 бит"), _("KOI8-R Код Обмена Информацией, 8 бит"), _("KOI8-U Код Обмена Информацией, 8 бит"), _("UTF8 - Universal Character Set"), _("ISO/IEC 6937"), _("ISO/IEC 8859-1 Latin-1 Western European"), _("ISO/IEC 8859-2 Latin-2 Central European"), _("ISO/IEC 8859-3 Latin-3 South European"), _("ISO/IEC 8859-4 Latin-4 North European"), _("ISO/IEC 8859-5 Latin/Cyrillic"), _("ISO/IEC 8859-6 Latin/Arabic"), _("ISO/IEC 8859-7 Latin/Greek"), _("ISO/IEC 8859-8 Latin/Hebrew"), _("ISO/IEC 8859-9 Latin/Turkish"), _("ISO/IEC 8859-10 Latin/Nordic"), _("ISO/IEC 8859-11 Latin/Thai"), _("ISO/IEC 8859-13 Latin-7 Baltic Rim"), _("ISO/IEC 8859-14 Latin-8 Celtic"), _("ISO/IEC 8859-15 Latin-9"), _("ISO/IEC 8859-16 Latin-10 South-Eastern European"), _("Windows CP1250 - Central and Eastern European"), _("Windows CP1251 - Cyrillic Script"), _("Windows CP1252 - ANSI"), _("Windows CP1253 - Greek Modern"), _("Windows CP1254 - Turkish"), _("Windows CP1255 - Hebrew"), _("Windows CP1256 - Arabic"), _("Windows CP1257 - Baltic"), _("Windows CP1258 - Vietnamese"), _("VSCII - Vietnamese Standard Code for Information Interchange"), _("TSCII - Tamil Script Code for Information Interchange"), _("JIS X 0201 - Japanese Industrial Standard "), _("TIS-620 - Thai Industrial Standard 620-2533"), _("EBCDIC 037 - Extended Binary Coded Decimal Interchange Code 037"), _("EBCDIC 285 - Extended Binary Coded Decimal Interchange Code 285"), _("EBCDIC 500 - Extended Binary Coded Decimal Interchange Code 500"), _("EBCDIC 875 - Extended Binary Coded Decimal Interchange Code 875"), _("EBCDIC 1026 - Extended Binary Coded Decimal Interchange Code 1026"), _("EBCDIC 1047 - Extended Binary Coded Decimal Interchange Code 1047"), _("EBCDIC 1140 - Extended Binary Coded Decimal Interchange Code 1140"), _("EBCDIC 1146 - Extended Binary Coded Decimal Interchange Code 1146"), _("EBCDIC 1148 - Extended Binary Coded Decimal Interchange Code 1148"), _("ANSEL - American National Standard for Extended Latin"), _("DEC Multinational Character Set - VT220"), _("Macintosh CP10000 - Roman"), _("Macintosh CP10029 - Macintosh Central European"), _("OEM - IBM PC/DOS CP437 - MS-DOS Latin US"), _("PC/DOS CP720 - MS-DOS Arabic"), _("PC/DOS CP737 - MS-DOS Greek"), _("PC/DOS CP775 - MS-DOS Baltic Rim"), _("PC/DOS CP850 - MS-DOS Latin 1"), _("PC/DOS CP852 - MS-DOS Latin 2"), _("PC/DOS CP855 - MS-DOS Cyrillic"), _("PC/DOS CP857 - MS-DOS Turkish"), _("PC/DOS CP858 - MS-DOS Latin 1 Update"), _("PC/DOS CP860 - MS-DOS Portuguese"), _("PC/DOS CP861 - MS-DOS Icelandic"), _("PC/DOS CP862 - MS-DOS Hebrew"), _("PC/DOS CP863 - MS-DOS French Canada"), _("PC/DOS CP864 - MS-DOS Arabic 2"), _("PC/DOS CP866 - MS-DOS Cyrillic Russian"), _("PC/DOS CP869 - MS-DOS Greek 2"), _("PC/DOS CP874 - MS-DOS Thai"), _("DOS MIK Code page"), _("DOS Kamenický Encoding"), _("DOS Mazovia Encoding"), _("DOS Iran System Encoding Standard") };
	...
	chcCharacterEncoding->SetSelection( 7 );
